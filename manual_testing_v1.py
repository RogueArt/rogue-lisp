...
def get_test_programs():
    ...
    simple = ['(class main', '(method main ()', '(print "Hello world!")'
              , ')', ')']
    ...
    nested_begin_test = [
        ...
        '(field obj_ref_field_puppy null)',
        '(method main () (begin',
        '(begin(print "foo_123 is " foo_123)',
        ')',
        '(begin(begin(begin(print "name is " name)',
        '(print "_awesome is " _awesome)begin',
        '))',
        ')',
        ')',
        '))',
    ...
    set_fields = [
        ...
        '(set name true)',
        '(set _awesome 0)',
        '(set obj_ref_field_puppy (new puppy))(print "The value is " foo_123 " and " name " and " _awesome " and value is " (% 3 2)))'
            ,
        ')',
        ')',
        ]
    ...
    basic_self_call_test = [
        '(class main',
        '(method bark () (print "its a me, mario!"))',
        '(field puppy_ref null)',
        '(method main ()',
        '(begin',
        '(call me bark)',
    ...
    integer_comparison = [  # '(print "(/ 5 0) " (/ 5 0))             # error',
                            # '(print "(% 5 0) " (% 5 0))             # error',
        '(class main',
    ...
    boolean_comparison = [  # Do NOT allow null and boolean to be made into a comparison
    ...
    string_comparison = [  # true
        ...
        '(print "(<= banana banana) " (<= "banana" "banana"))',
    ...
    null_comparison = [  # true
                         # false
                         # false
                         # true
        '(class main',
        '(field object null)(method main ()',
        '(begin',
        '(print "(== null object) " (== null object))',
        '(print "(!= null object) " (!= null object))',
        '(set object (new main))',
        '(print "Object is now non-null")(print "(== null object) " (== null object))'
            ,
        '(print "(!= null object) " (!= null object))',
        ')',
        ')',
    ...
    input_int_test = [
        ...
        '(method main ()',
        '(begin',
        '(print "Please enter a number: ")(inputi x) # input value from user, store in x variable'
            ,
    ...
    input_str_test = [
        ...
        '(method main ()',
        '(begin',
        '(print "Please enter your favorite game: ")(inputs x) # input value from user, store in x variable'
            ,
    ...
    # Test parameter instantiation - try passing an instantiated object as a parameter
    ...
    test_instantiation_in_parameter = [
        '(class main',
        '(method main ()',
        '(begin',
        '(call me say_something (new animal))',
        ')',
        ')',
        '(method say_something (animal_ref)',
        '(call animal_ref speak)',
        ')',
        ')',
        '(class animal',
        '(method speak ()',
    ...
    test_instantiation_in_caller = [
        '(class main',
        '(method main ()',
        '(begin',
        '(call (new animal) say "cawwww! " "bird")',
        ')',
        ')',
        ')',
        '(class animal',
        '(method say (sound type) ',
        '(print sound type)',
        ')',
        ')',
        ]
    ...
    return {  # 'test_say_hello': test_say_hello
        'simple': simple,
        'many_fields': many_fields,
        'simple_begin_test': simple_begin_test,
        'nested_begin_test': nested_begin_test,
        'set_fields': set_fields,
        'basic_other_call_test': basic_other_call_test,
        'basic_self_call_test': basic_self_call_test,
        'parameter_other_call_test': parameter_other_call_test,
        ...
        'parameter_scoping_test': parameter_scoping_test,
        'if_statement': if_statement,
        'if_else_statement': if_else_statement,
        'while_statement_false': while_statement_false,
        'while_statement_return': while_statement_return,
        'non_control_flow_return': non_control_flow_return,
        'test_set_instantiation': test_set_instantiation,
        'test_inline_instantiation': test_inline_instantiation,
        'test_return_instantiation': test_return_instantiation,
        'test_null_return_instantiation': test_null_return_instantiation,
        'test_instantiation_in_parameter': test_instantiation_in_parameter,
        'test_instantiation_in_caller': test_instantiation_in_caller,
        'input_int_test': input_int_test,
        'input_str_test': input_str_test
        }
